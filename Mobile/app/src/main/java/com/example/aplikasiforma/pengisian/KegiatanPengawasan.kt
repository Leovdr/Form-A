...
class KegiatanPengawasan : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        progressDialog.setMessage("Menyimpan data...") // Pesan yang akan ditampilkan di dialog
        progressDialog.setCancelable(false) // ProgressDialog tidak bisa di-dismiss oleh pengguna
        ...
        btnNext.setOnClickListener {
            ...
            if (bentuk.isNotEmpty() && tujuan.isNotEmpty() && sasaran.isNotEmpty() && waktuTempat.isNotEmpty()) {
                // Tampilkan ProgressDialog saat proses unggah dimulai
                progressDialog.show()
                ...
                uploadKegiatanPengawasanToDatabase(bentuk, tujuan, sasaran, waktuTempat) { success ->
                    // Selalu hentikan ProgressDialog setelah proses selesai
        ...
        if (uid != null) {
            ...
            val stringRequest = object : StringRequest(
                ...
                { error ->
                    ...
                    Toast.makeText(this@KegiatanPengawasan, "Error: ${error.message}", Toast.LENGTH_SHORT).show()
                    callback(false)
                }) {
